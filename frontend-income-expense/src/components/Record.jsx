  ...
  return (
    <div className="w-screen h-fit flex flex-col items-center bg-slate-100">
      ...
      <div className="w-[1200px] h-[1080px] flex gap-6 mt-6">
        <div className="w-[282px] h-full flex flex-col px-4 gap-6 rounded-lg bg-white border">
          <div className="w-[250px] h-[88px] flex flex-col justify-between ">
            <div className="text-2xl font-semibold">Record</div>
            <button className="w-full h-8 bg-blue-600 rounded-[20px] flex justify-center items-center gap-3 text-white">
              <PiPlus className="w-6 h-6" />
              Add
            </button>
          </div>
          ...
          <div className="w-[250px] h-[520px] flex flex-col gap-4 ">
            ...
            <div className="w-[245px] h-[152px] flex flex-col gap-4 border">
              <div className="text-base font-semibold">Amount Range</div>
              <div className="w-full h-[112px] flex flex-col gap-4 border">
        ...
        <div className="w-[894px] h-full flex flex-col gap-6 border">
